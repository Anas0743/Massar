...
const metadata = [
  ...
  { pattern: /^\/forgot-password$/, title: "استعادة كلمة المرور - مسار", description: "اطلب رابطا آمنا لاستعادة كلمة مرور حسابك في مسار." },
  { pattern: /^\/reset-password$/, title: "تعيين كلمة المرور - مسار", description: "عيّن كلمة مرور جديدة لحسابك في مسار من رابط الاستعادة الآمن." },
