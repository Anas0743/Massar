...
EXPERTS = [
    ...
    },
    {
        ...
        "company": "Apps Hub",
        "years": 5,
        "bio": "تقدم إرشادًا في Flutter وReact Native وبناء نسخة أولى واضحة لمشروع الجامعة أو التدريب.",
        "price": 28,
...
FAQS = [
    ...
    ("هل الدفع إلكتروني؟", "حاليًا الدفع يدوي، وتوجد حالة دفع قابلة للربط لاحقًا مع Stripe أو CliQ أو Zain Cash.", 2),
